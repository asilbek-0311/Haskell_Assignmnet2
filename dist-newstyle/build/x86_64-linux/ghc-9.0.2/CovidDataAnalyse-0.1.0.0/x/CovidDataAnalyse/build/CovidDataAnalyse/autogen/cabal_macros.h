...
/* package CovidDataAnalyse-0.1.0.0 */
#ifndef VERSION_CovidDataAnalyse
#define VERSION_CovidDataAnalyse "0.1.0.0"
#endif /* VERSION_CovidDataAnalyse */
#ifndef MIN_VERSION_CovidDataAnalyse
#define MIN_VERSION_CovidDataAnalyse(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CovidDataAnalyse */
...
#define CURRENT_COMPONENT_ID "CovidDataAnalyse-0.1.0.0-inplace-CovidDataAnalyse"
